 ...
 */
package com.wendy.restnog.service;
...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(com.wendy.restnog.service.AccountFacadeREST.class);
        resources.add(com.wendy.restnog.service.AdresFacadeREST.class);
        resources.add(com.wendy.restnog.service.ArtikelFacadeREST.class);
        resources.add(com.wendy.restnog.service.BestellingFacadeREST.class);
        resources.add(com.wendy.restnog.service.BestellingartikelFacadeREST.class);
        resources.add(com.wendy.restnog.service.BetalingFacadeREST.class);
        resources.add(com.wendy.restnog.service.FactuurFacadeREST.class);
        resources.add(com.wendy.restnog.service.KlantFacadeREST.class);
        resources.add(com.wendy.restnog.service.KlantadresFacadeREST.class);
        resources.add(com.wendy.restnog.service.MedewerkerFacadeREST.class);
        resources.add(controllers.ArtikelBeheer.class);
        resources.add(controllers.GebruikerBeheer.class);
        resources.add(controllers.RegistratieService.class);
